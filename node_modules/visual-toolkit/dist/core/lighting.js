 ...
 * }
 */
export function calculateIllumination(lightX, lightY, targetX, targetY, awarenessRadius = 200) {
 ...
 */
export function calculateDirectionalIllumination(lightX, lightY, targetX, targetY, facingAngle, awarenessRadius = 200) {
    const baseIllumination = calculateIllumination(lightX, lightY, targetX, targetY, awarenessRadius);
    if (baseIllumination === 0)
        return 0;
 ...
 * });
 */
export function drawPlayerLight(ctx, x, y, radius = 120, options = {}) {
    const { intensity = 1, pulseTime, coreColor = { r: 255, g: 255, b: 255 }, ambientColor = { r: 180, g: 220, b: 255 }, } = options;
 ...
 * });
 */
export function drawOrganicTexture(ctx, width, height, options = {}) {
    const { density = 20, color = { r: 20, g: 30, b: 40 }, intensity = 0.15, time = 0, seed = 12345, } = options;
 ...
 */
export function drawCaustics(ctx, width, height, time, options = {}) {
    const { count = 5, heightRatio = 0.4, intensity = 0.03, } = options;
