 ...
 */
export function deepWaterBackground(ctx, height) {
 ...
 */
export function material3D(ctx, x, y, width, height, colors) {
 ...
 */
export function radialGlow(ctx, x, y, innerRadius, outerRadius, colors) {
 ...
 */
export function playerLight(ctx, x, y, radius, intensity = 1) {
    const gradients = [];
 ...
 */
export function lightBeam(ctx, startY, endY) {
 ...
 */
export function vignette(ctx, centerX, centerY, innerRadius, outerRadius, intensity = 0.5) {
 ...
 */
export function eyeGlow(ctx, x, y, size, illumination = 0) {
 ...
 */
export function cssBioGlow(color = 'cyan') {
 ...
 */
export function cssCreatureBody(opacity = 0.8) {
    return `radial-gradient(
    ellipse at 40% 40%,
 ...
 */
export function cssJellyfishBell() {
    return `radial-gradient(
    ellipse at 50% 30%,
 ...
 */
export function cssDistantCreature() {
    return `radial-gradient(
    ellipse at center,
    rgba(10, 20, 35, 0.8) 0%,
    transparent 70%
