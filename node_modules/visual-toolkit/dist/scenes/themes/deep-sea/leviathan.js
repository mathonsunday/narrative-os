...
export class LeviathanScene extends BaseCanvasScene {
    constructor() {
        super(...arguments);
        this.name = 'Leviathan';
        this.description = 'Encounter with a massive, ancient creature';
        this.defaultConfig = {
            intensity: 0.8,
            duration: Infinity,
        };
    ...
    render(ctx, deltaTime) {
        ...
        if (this.leviathan.active) {
            ...
            const distFromEdge = Math.min(this.leviathan.x + 300, width - this.leviathan.x + 400);
            ...
            const blockGrad = ctx.createRadialGradient(this.leviathan.x, this.leviathan.y, this.leviathan.size * 0.5, this.leviathan.x, this.leviathan.y, blockRadius);
            ...
            ctx.quadraticCurveTo(this.leviathan.x - this.leviathan.direction * this.leviathan.size * 1.5, this.leviathan.y + Math.sin(this.time * 0.003) * 30, this.leviathan.x - this.leviathan.direction * this.leviathan.size * 2.2, this.leviathan.y + Math.sin(this.time * 0.002) * 50);
            ctx.quadraticCurveTo(this.leviathan.x - this.leviathan.direction * this.leviathan.size * 1.5, this.leviathan.y - Math.sin(this.time * 0.003) * 20, this.leviathan.x - this.leviathan.direction * this.leviathan.size, this.leviathan.y);
            ctx.fill();
            ...
            const eyeIllumination = cursorX > 0
                ? Math.max(0, 1 - Math.sqrt(Math.pow(cursorX - eyeX, 2) + Math.pow(cursorY - eyeY, 2)) / 200)
                : 0;
            ...
            eyeGlow.addColorStop(0, `rgba(${180 + eyeIllumination * 75}, ${60 + eyeIllumination * 40}, ${60 + eyeIllumination * 20}, ${this.leviathan.opacity * (0.8 + eyeIllumination * 0.2)})`);
            eyeGlow.addColorStop(0.5, `rgba(${120 + eyeIllumination * 60}, 40, 40, ${this.leviathan.opacity * (0.3 + eyeIllumination * 0.3)})`);
            ...
            ctx.fillStyle = `rgba(${200 + eyeIllumination * 55}, ${80 + eyeIllumination * 80}, ${60 + eyeIllumination * 40}, ${this.leviathan.opacity})`;
            ctx.beginPath();
            ...
            for (let i = 0; i < baseSpotCount + bonusSpots; i++) {
                ...
                const spotX = this.leviathan.x - this.leviathan.direction * (this.leviathan.size * 0.3 + ((i % 8) * this.leviathan.size * 0.25));
                const spotY = this.leviathan.y +
        ...
        if (cursorX > 0) {
            ...
            const lightGrad = ctx.createRadialGradient(cursorX, cursorY, 0, cursorX, cursorY, lightRadius);
