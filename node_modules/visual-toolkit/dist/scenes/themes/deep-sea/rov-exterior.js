...
export class ROVExteriorScene extends BaseCanvasScene {
    constructor() {
        super(...arguments);
        this.name = 'ROV Exterior';
        this.description = 'External camera - ROV Nereid descent';
        this.defaultConfig = {
            intensity: 0.7,
            duration: Infinity,
        };
    ...
    material3D(ctx, x, y, width, height, colors) {
    ...
    drawPanelLines(ctx, x, y, width, height, positions) {
    ...
    drawGrille(ctx, x, y, width, height, lineCount) {
    ...
    drawLens(ctx, x, y, outerR, innerR) {
    ...
    drawTether(ctx, startX, startY, endY, wobbleAmt) {
