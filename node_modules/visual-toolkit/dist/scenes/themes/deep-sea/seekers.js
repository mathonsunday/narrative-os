...
import { deepWaterBackground, drawPlayerLight, createMarineSnow, updateMarineSnow, drawMarineSnow, vignette, createSeekerSwarm, updateSeekerSwarm, drawSeekerSwarm, } from '../../../themes/deepSea/effects.js';
export class SeekersScene extends BaseCanvasScene {
    constructor() {
        super(...arguments);
        this.name = 'Seekers';
        this.description = 'Bioluminescent seekers attracted to light';
        this.defaultConfig = {
            intensity: 1,
            scale: 1,
            duration: Infinity,
    ...
    render(ctx, deltaTime) {
        ...
        const cursorSpeed = Math.sqrt((cursor.x - this.lastCursorX) ** 2 + (cursor.y - this.lastCursorY) ** 2);
        // Update seeker behavior using shared effect
        updateSeekerSwarm(this.seekers, cursor.x, cursor.y, cursorSpeed, width, height, 0.02 // centerDrift
        );
