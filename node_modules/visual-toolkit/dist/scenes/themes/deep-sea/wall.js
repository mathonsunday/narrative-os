...
export class WallScene extends BaseCanvasScene {
    constructor() {
        super(...arguments);
        this.name = 'The Wall';
        this.description = 'A massive organic surface covered in watching eyes';
        this.defaultConfig = {
            intensity: 0.8,
            duration: Infinity,
        };
    ...
    drawOrganicSurface(ctx, w, h, options) {
        ...
        if (lightX > 0 && lightY > 0) {
            ...
            scatter.addColorStop(0, `rgba(${this.palette.veinHighlight.r + 20}, ${this.palette.veinHighlight.g}, ${this.palette.veinHighlight.b - 10}, 0.15)`);
            ...
            highlight.addColorStop(0, `rgba(${this.palette.highlight.r + 40}, ${this.palette.highlight.g + 35}, ${this.palette.highlight.b + 30}, 0.2)`);
    ...
    drawTrackingEye(ctx, eyeX, eyeY, eyeSize, targetX, targetY, illumination, openness) {
        if (openness < 0.05)
            return; // Too closed to see
