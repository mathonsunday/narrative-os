 ...
 */
export function drawOffsetShadow(ctx, drawFn, offsetX = 4, offsetY = 4, color = darkness.shadow) {
    ctx.save();
 ...
 */
export function applyShadow(ctx, blur, color, offsetX = 0, offsetY = 0) {
 ...
 */
export function cssGlow(color, intensity = 'medium') {
    const multipliers = {
        subtle: [0.3, 0.15],
        medium: [0.6, 0.3],
        strong: [0.9, 0.5],
 ...
 */
export function cssJellyfishGlow() {
    return `
 ...
 */
export function cssBreathingGlow() {
    return {
 ...
 */
export function drawWithDepth(ctx, preset, drawShape, fillGradient) {
