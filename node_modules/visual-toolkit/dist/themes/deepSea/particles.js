 ...
 */
export function createMarineSnow(count = 80) {
 ...
 */
export function updateMarineSnow(particles, direction = 'down') {
 ...
 */
export function drawMarineSnow(ctx, particles, width, height) {
    for (const p of particles) {
        ctx.beginPath();
 ...
 */
export function createDeepParticles(count = 12) {
    return Array.from({ length: count }, () => ({
        x: Math.random(),
        y: Math.random(),
 ...
 */
export function updateDeepParticles(particles, time) {
    for (const p of particles) {
        p.y += p.speed;
 ...
 */
export function cssMarineSnowParticle(index) {
 ...
 */
export function htmlMarineSnow(count = 20) {
 ...
 */
export function createBioParticles(count = 15) {
    return Array.from({ length: count }, () => ({
        x: Math.random(),
        y: Math.random(),
 ...
 */
export function drawBioParticles(ctx, particles, width, height, time) {
    for (const p of particles) {
