 ...
 * });
 */
export declare function drawROV(ctx: CanvasRenderingContext2D, x: number, y: number, scale?: number, options?: ROVOptions): void;
 ...
 * });
 */
export declare function drawLightCone(ctx: CanvasRenderingContext2D, x: number, y: number, angle: number, length: number, options?: LightConeOptions): void;
 ...
 * });
 */
export declare function drawJellyfish(ctx: CanvasRenderingContext2D, x: number, y: number, options?: JellyfishOptions): void;
 ...
 * });
 */
export declare function drawSpecimen(ctx: CanvasRenderingContext2D, x: number, y: number, options?: SpecimenOptions): void;
