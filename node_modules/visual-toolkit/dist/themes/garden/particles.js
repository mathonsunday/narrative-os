 ...
 */
export function createPollen(count = 35) {
    const particles = [];
 ...
 */
export function updatePollen(particles, ctx, width, height, time) {
 ...
 */
export function createFloatingLeaves(count = 18) {
    const shapes = ['oval', 'pointed', 'round'];
    const particles = [];
    for (let i = 0; i < count; i++) {
        particles.push({
            x: Math.random() * 100,
 ...
 */
export function updateFloatingLeaves(particles, ctx, width, height, time) {
    particles.forEach((particle) => {
 ...
 */
export function createDustMotes(count = 55) {
    const particles = [];
    for (let i = 0; i < count; i++) {
        particles.push({
            x: Math.random() * 100,
 ...
 */
export function updateDustMotes(particles, ctx, width, height, time) {
    particles.forEach((particle) => {
 ...
 */
export function createOvergrownParticles(count = 75) {
    const particles = [];
    for (let i = 0; i < count; i++) {
 ...
 */
export function updateOvergrownParticles(particles, ctx, width, height, time) {
    particles.forEach((particle) => {
