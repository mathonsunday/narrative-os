 ...
 */
export function drawFrostedGlassOverlay(ctx, width, height, intensity = 0.15) {
    ctx.save();
    // Base frosted tint
 ...
 */
export function drawGlassSmudges(ctx, width, height, smudgeCount = 8) {
    ctx.save();
 ...
 */
export function drawDepthFog(ctx, width, height, baseColor = 'rgba(255, 255, 255, 0.3)', layerCount = 3) {
    ctx.save();
 ...
 */
export function drawVignette(ctx, width, height, intensity = 0.3) {
    ctx.save();
 ...
 */
export function drawOrganicNoise(ctx, width, height, intensity = 0.2, scale = 20) {
    ctx.save();
 ...
 */
export function drawLensReflection(ctx, x, y, size = 40, intensity = 0.3) {
    ctx.save();
 ...
 */
export function drawLensDamage(ctx, width, height, crackCount = 3) {
    ctx.save();
 ...
 */
export function drawLightRays(ctx, width, height, rayCount = 4, intensity = 0.2) {
    ctx.save();
 ...
 */
export function drawEdgeVignette(ctx, width, height, color = 'rgba(0, 0, 0, 0.3)', edgeWidth = 40) {
    ctx.save();
    // Top
    ctx.fillStyle = color;
 ...
 */
export function drawAnimatedShimmer(ctx, x, y, width, height, time, intensity = 0.15) {
    ctx.save();
    // Create wave effect
