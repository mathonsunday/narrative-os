 ...
 */
export function calculateSway(options) {
    const { intensity = 0.5, speed = 1.0, time, baseRotation = 0, } = options;
 ...
 */
export function calculateDrift(options) {
    const { intensity = 0.5, speed = 1.0, time, baseX = 0, baseY = 0, } = options;
 ...
 */
export function applySway(ctx, x, y, options) {
 ...
 */
export function applyDrift(ctx, options) {
 ...
 */
export function calculateGrowthProgress(options) {
    const { baseGrowth, time, seed = 0, style = 'linear', } = options;
 ...
 */
export function calculateTipGrowthMultiplier(distanceFromBase, time, seed = 0) {
 ...
 */
export function calculatePulse(options) {
    const { time, intensity = 0.15, speed = 1, minOpacity = 0.8, } = options;
 ...
 */
function pulseRange(value, range, intensity) {
 ...
 */
export function calculateScalePulse(time, intensity = 0.02, speed = 1) {
 ...
 */
export function applyGrowthTiming(baseGrowth, time, preset = 'slow', seed = 0) {
